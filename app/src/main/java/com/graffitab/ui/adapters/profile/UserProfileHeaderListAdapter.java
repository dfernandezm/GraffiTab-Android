 ...
 */
public class UserProfileHeaderListAdapter extends ListStreamablesRecyclerViewAdapter {

    public UserProfileHeaderListAdapter(Context context, List<GTStreamable> items) {
        super(context, items);
    }
